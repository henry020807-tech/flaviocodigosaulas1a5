...
x<-matrix(data=c(0,0,0,1,1,0,1,1), nrow=4,ncol=2,byrow = TRUE) #entrada da XOR (A e B Tabela verdadeira)
y<-matrix(data=c(0,1,1,0,1 ,0,0,1), nrow=4,ncol=2,byrow = TRUE) #saída da XOR (A e B Tabela verdadeira)
i1<-1
i4<-1
i5<-1
i8<-1
